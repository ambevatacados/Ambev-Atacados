// Envio de emails via Resend — Central de Atacados
...
//  - cabeçalho com o nome da empresa em HTML (sem depender de imagem externa)
//  - botões levam ao WhatsApp (WHATSAPP_NUMBER) com mensagem pronta

const { Resend } = require("resend");
const T = require("./templates");

const SENDER_NAME = "Central de Atacados"; // nome fixo do remetente (ignora SENDER_NAME do ambiente)
// Sem domínio verificado no Resend, onboarding@resend.dev só entrega para o email da própria conta.
const SENDER_EMAIL = process.env.SENDER_EMAIL || "onboarding@resend.dev";
const REPLY_TO = process.env.REPLY_TO || "";
const COMPANY_NAME = "Central de Atacados"; // nome fixo da empresa nos emails
const CONTACT_EMAIL = "faleconosco@centraldeatacados.com.br"; // email fixo de contato
const BASE_URL = (process.env.BASE_URL || "https://ambev-atacados.vercel.app").replace(/\/$/, "");
const LOGO_URL = process.env.LOGO_URL || BASE_URL + "/brand/logo-light.svg";
