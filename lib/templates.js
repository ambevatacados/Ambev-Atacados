// Templates de email — Central de Atacados (tema vermelho/branco)
...
function button(label, url, color) {
  return `
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:32px auto 12px;">
        <tr>
          <td align="center" bgcolor="${color}" style="border-radius:8px;box-shadow:0 4px 12px rgba(228,0,43,0.25);">
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8f9fa;">
  <tr>
    <td align="center" style="padding:40px 16px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:100%;width:600px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 8px 24px rgba(228,0,43,0.08);">

        <!-- Cabeçalho: wordmark em HTML (renderiza em todos os clientes de email, sem depender de imagem) -->
        <tr>
          <td bgcolor="#E4002B" style="background:#E4002B;padding:30px 40px 26px;text-align:center;">
            <div style="font-family:Arial,Helvetica,sans-serif;font-size:34px;line-height:1;font-weight:800;color:#ffffff;letter-spacing:3px;">CENTRAL</div>
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:10px auto 0;">
              <tr><td bgcolor="#ffffff" style="border-radius:999px;padding:6px 18px;font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:800;color:#E4002B;letter-spacing:2px;">DE ATACADOS</td></tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:${C.primary};padding:36px 40px;font-family:inherit;text-align:center;">
            ...
            <div style="font-size:13px;color:#ffd6dc;margin-top:12px;line-height:1.8;">
            ...
            <div style="font-size:12px;color:#ffb3bd;margin-top:14px;line-height:1.6;">
              Este é um e-mail automático sobre o seu pedido. Se tiver dúvidas, é só responder esta mensagem.
            </div>
            <div style="font-size:11px;color:#f28c9a;margin-top:16px;border-top:1px solid rgba(255,255,255,0.1);padding-top:16px;">
...
const AWAITING_PAYMENT_TEMPLATE = shell({
  ...
  content: `
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:20px;">
      <tr>
        <td align="center" style="background:#FFF5F5;border:2px solid #7a0016;border-radius:10px;padding:24px 20px;">
          <div style="font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#991B1B;">Prazo restante</div>
          <div style="font-size:44px;font-weight:800;color:#7a0016;line-height:1;margin:8px 0 6px;letter-spacing:-1px;">{{deadlineMinutes}} min</div>
  ...
  cta: button("Confirmar Pagamento", "{{whatsappUrl}}", "#7a0016"),
